...
export const CATALOG: CatalogEntry[] = [
  { name: 'Amsterdam', abbr: 'CEST', offset: 120 },
  { name: 'Athens', abbr: 'EEST', offset: 180 },
  { name: 'Auckland', abbr: 'NZST', offset: 780 },
  { name: 'Austin', abbr: 'CDT', offset: -300 },
  { name: 'Bangkok', abbr: 'ICT', offset: 420 },
  ...
  { name: 'Johannesburg', abbr: 'SAST', offset: 120 },
  { name: 'Karachi', abbr: 'PKT', offset: 300 },
  ...
  { name: 'Madrid', abbr: 'CEST', offset: 120 },
  { name: 'Manila', abbr: 'PHT', offset: 480 },
  { name: 'Melbourne', abbr: 'AEST', offset: 600 },
  { name: 'Mexico City', abbr: 'CST', offset: -360 },
  { name: 'Miami', abbr: 'EDT', offset: -240 },
  { name: 'Milan', abbr: 'CEST', offset: 120 },
  { name: 'Montreal', abbr: 'EDT', offset: -240 },
  { name: 'Moscow', abbr: 'MSK', offset: 180 },
  { name: 'Mumbai', abbr: 'IST', offset: 330 },
  { name: 'Nairobi', abbr: 'EAT', offset: 180 },
  { name: 'New Delhi', abbr: 'IST', offset: 330 },
  { name: 'New York', abbr: 'EDT', offset: -240 },
  { name: 'Oslo', abbr: 'CEST', offset: 120 },
  { name: 'Paris', abbr: 'CEST', offset: 120 },
  { name: 'Phoenix', abbr: 'MST', offset: -420 },
  { name: 'Reykjavik', abbr: 'GMT', offset: 0 },
  { name: 'Rome', abbr: 'CEST', offset: 120 },
  { name: 'San Francisco', abbr: 'PDT', offset: -420 },
  { name: 'Santiago', abbr: 'CLT', offset: -240 },
  { name: 'Sao Paulo', abbr: 'BRT', offset: -180 },
  { name: 'Seattle', abbr: 'PDT', offset: -420 },
  { name: 'Seoul', abbr: 'KST', offset: 540 },
  { name: 'Shanghai', abbr: 'CST', offset: 480 },
  { name: 'Singapore', abbr: 'SGT', offset: 480 },
  { name: 'Stockholm', abbr: 'CEST', offset: 120 },
  { name: 'Sydney', abbr: 'AEST', offset: 600 },
  { name: 'Taipei', abbr: 'CST', offset: 480 },
  ...
  { name: 'Washington DC', abbr: 'EDT', offset: -240 },
