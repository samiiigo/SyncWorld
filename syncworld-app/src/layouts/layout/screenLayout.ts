...
import { BorderRadius, Spacing, withAppFont } from '@/shared/theme';
import { useCreateStyles } from '@/shared/theme/createStyles';
import type { ColorPalette } from '@/shared/theme/colorPalettes';

/** Bottom inset so list content clears the native / classic tab bar. */
